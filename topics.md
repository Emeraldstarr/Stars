...
- [tools-collection/apis-collection](https://github.com/tools-collection/apis-collection) - Community maintained, human, machine and AI readable list of Public APIs 📝
- [TonnyL/Awesome_APIs](https://github.com/TonnyL/Awesome_APIs) - :octocat: A collection of APIs
...
- [ma2za/python-substack](https://github.com/ma2za/python-substack) - Write and safely manage Substack drafts from Markdown with Python, CLI, and MCP.
...
- [open-horizon-labs/obsidian-ics](https://github.com/open-horizon-labs/obsidian-ics) - Generate Daily Planner from ical feeds
...
- [Artel250/Obsidian-Gemini-Assistant](https://github.com/Artel250/Obsidian-Gemini-Assistant) - An obsidian plugin that enables you to talk to Google Gemnini directly
